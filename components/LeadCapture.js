    ...
    <section className={compact ? 'audit compact-audit section-dark' : 'audit section-dark'} id="audit">
      ...
      {ghlFormUrl ? (
        ...
        <div className="audit-card">
          <h3>Written intake area</h3>
          <p>This block is ready for your GoHighLevel form or calendar embed. The dedicated intake page keeps the deeper form separate from ESA chat.</p>
          <a className="btn btn-gold" href={ghlBookingUrl}>Book Demo</a>
          <a className="btn btn-outline audit-secondary" href="/intake">Open Intake Page</a>
        </div>
      )}
    </section>
  );

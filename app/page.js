    ...
    <>
      ...
      <main>
        <section className="hero section-dark">
          ...
          <div className="hero-visual" aria-label="Essential Solutions dashboard preview">
            <div className="orbit-card">
              <img src="/es-app-icon.png" alt="Essential Solutions app icon" />
            </div>
        ...
        <section className="section" id="industries">
          ...
          <div className="industry-grid">
            <a href="/auto-repair">Auto Repair</a><a>Med Spas</a><a>Dental Offices</a><a>Home Services</a><a>Law Offices</a><a>Logistics</a><a>Contractors</a><a>Cleaning Companies</a>
          </div>
        </section>
